...
export default function ScheduleManagementPage() {
  const [scheduleRecords, setScheduleRecords] = useState<ScheduleRecord[]>(schedules)
                ...
                <div key={index} className="border rounded-lg p-4">
                  <div className="flex items-center justify-between mb-3">
                    <div>
                      ...
                      <p className="text-sm text-gray-600">{new Date(day.date).toLocaleDateString("en-US", {
                        year: "numeric",
                        month: "2-digit",
                        day: "2-digit"
                      })}</p>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => updateEditingRecord("department", e.target.value)}
                  />
                </div>
                <div className="space-y-2">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => updateEditingRecord("startTime", e.target.value)}
                  />
                </div>
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => updateEditingRecord("endTime", e.target.value)}
                  />
                </div>
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => updateEditingRecord("breakTime", e.target.value)}
                ...
                <div className="space-y-2">
                  ...
                  <Select value={editingRecord.type} onValueChange={(value) => updateEditingRecord("type", value)}>
                    <SelectTrigger>
                ...
                {editingRecord.conflict && (
                  <div className="col-span-2 space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) => updateEditingRecord("conflict", e.target.value)}
