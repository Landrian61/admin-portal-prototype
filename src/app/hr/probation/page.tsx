...
import { Plus, Search, Filter, User, Calendar, Clock, CheckCircle, AlertTriangle, FileText, Edit, Download } from "lucide-react"
      ...
      <div className="space-y-6">
            ...
            <Card key={employee.id} className="hover:shadow-lg transition-shadow">
              ...
              <CardContent className="space-y-4">
                  ...
                  <div className="w-full bg-gray-200 rounded-full h-2">
                    <div 
                      className={`h-2 rounded-full transition-all duration-300 ${
                        ...
                        employee.progress >= 60 ? 'bg-blue-500' : 
                        employee.progress >= 40 ? 'bg-yellow-500' : 'bg-red-500'
                      }`}
                ...
                {employee.reviews.length > 0 && (
                  <div>
                    <p className="text-sm font-medium text-gray-700 mb-2">Latest Review:</p>
                    <div className="bg-gray-50 p-3 rounded-lg">
                      <div className="flex items-center justify-between mb-1">
                        <span className="text-xs text-gray-500">
                          {new Date(employee.reviews[employee.reviews.length - 1].date).toLocaleDateString()}
                        </span>
                        <span className={`text-sm font-bold ${getRatingColor(employee.reviews[employee.reviews.length - 1].rating)}`}>
                          {employee.reviews[employee.reviews.length - 1].rating}/5
                        </span>
                      </div>
                ...
                {/* Goals Progress */}
                <div>
                  <p className="text-sm font-medium text-gray-700 mb-2">Goals Progress:</p>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Scheduled probation reviews for the next 30 days</CardDescription>
          </CardHeader>
          <CardContent>
              ...
              <div className="flex items-center justify-between p-3 rounded-lg bg-gray-50">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">3-month review • Due: March 15, 2024</p>
                  </div>
                </div>
              ...
              <div className="flex items-center justify-between p-3 rounded-lg bg-gray-50">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Final review • Due: April 8, 2024</p>
                  </div>
                </div>
                <Button size="sm" variant="outline">
                  Schedule Review
